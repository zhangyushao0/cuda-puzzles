...
// ---------------------------------------------------------------
TEST_CASE("small_array", "[puzzle_01]") {
  const int N = 8;
  ...
  // Verify
  REQUIRE(check_array_close(C, expected, N));
...
// ---------------------------------------------------------------
TEST_CASE("medium_array", "[puzzle_01]") {
  const int N = 1024;
  float *A = new float[N];
  float *B = new float[N];
  float *C = new float[N];
...
// ---------------------------------------------------------------
TEST_CASE("large_array", "[puzzle_01]") {
  const int N = 1000000;
  float *A = new float[N];
  float *B = new float[N];
  float *C = new float[N];
...
// ---------------------------------------------------------------
TEST_CASE("non_divisible_size", "[puzzle_01]") {
